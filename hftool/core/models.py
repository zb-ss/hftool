...
MODEL_REGISTRY: Dict[str, Dict[str, ModelInfo]] = {
    ...
    "text-to-video": {
        ...
        "wan2.2-14b": ModelInfo(
            repo_id="Wan-AI/Wan2.2-T2V-A14B-Diffusers",
            name="Wan 2.2 (A14B MoE)",
            model_type=ModelType.DIFFUSERS,
            size_gb=55.0,
            description="Wan 2.2 MoE text-to-video (27B total, 14B active)",
        ...
        "wan2.2-5b": ModelInfo(
            ...
            model_type=ModelType.DIFFUSERS,
            size_gb=12.0,
            description="Wan 2.2 efficient T2V+I2V model (720P@24fps)",
            metadata={"num_inference_steps": 50, "guidance_scale": 5.0},
            pip_dependencies=["ftfy>=6.0.0"],
        ),
        "ltx2-19b": ModelInfo(
            ...
            model_type=ModelType.DIFFUSERS,
            size_gb=40.0,
            description="LTX-2 audio-video foundation model (19B params, requires CUDA 12.7+)",
            pip_dependencies=["diffusers>=0.36.0"],
            metadata={
                "num_inference_steps": 50,
                "guidance_scale": 3.0,
                "num_frames": 97,
        ...
        "ltx2-19b-distilled": ModelInfo(
            ...
            model_type=ModelType.DIFFUSERS,
            size_gb=40.0,
            description="LTX-2 distilled version (8 steps, faster inference)",
            pip_dependencies=["diffusers>=0.36.0"],
            metadata={
    ...
    "image-to-video": {
        ...
        "wan2.2-14b-i2v": ModelInfo(
            repo_id="Wan-AI/Wan2.2-I2V-A14B-Diffusers",
            name="Wan 2.2 I2V (A14B MoE)",
            model_type=ModelType.DIFFUSERS,
            size_gb=55.0,
            description="Wan 2.2 MoE image-to-video (27B total, 14B active)",
            metadata={"num_inference_steps": 50, "guidance_scale": 5.0},
            pip_dependencies=["ftfy>=6.0.0"],
        ),
        "wan2.2-5b-i2v": ModelInfo(
            repo_id="Wan-AI/Wan2.2-TI2V-5B-Diffusers",
            name="Wan 2.2 TI2V (5B) I2V",
            model_type=ModelType.DIFFUSERS,
            size_gb=12.0,
            description="Wan 2.2 efficient I2V model (720P@24fps)",
            metadata={"num_inference_steps": 50, "guidance_scale": 5.0},
            pip_dependencies=["ftfy>=6.0.0"],
        ),
        "ltx2-19b-i2v": ModelInfo(
            ...
            model_type=ModelType.DIFFUSERS,
            size_gb=40.0,
            description="LTX-2 image-to-video (19B params, requires CUDA 12.7+)",
            pip_dependencies=["diffusers>=0.36.0"],
            metadata={
                "num_inference_steps": 50,
                "guidance_scale": 3.0,
        ...
        "ltx2-19b-distilled-i2v": ModelInfo(
            ...
            model_type=ModelType.DIFFUSERS,
            size_gb=40.0,
            description="LTX-2 distilled image-to-video (8 steps, faster)",
            pip_dependencies=["diffusers>=0.36.0"],
            metadata={
                "num_inference_steps": 8,
                "guidance_scale": 1.0,
